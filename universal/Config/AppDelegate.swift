    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if let activityDictionary = launchOptions?[UIApplicationLaunchOptionsKey.userActivityDictionary] as? [AnyHashable: Any] {
            ...
            for key in activityDictionary.keys {
                acceptedURL = proceedUniversalLink(dict: activityDictionary, key: key)
            }
...
extension AppDelegate {
    ...
    func handleUrl(url: URL) {
        ...
        deepLinkData = DeepLinkModel(type: type, id: parameters["id"], categoryId: parameters["categoryId"])
        handleDeepLink(data: deepLinkData ?? DeepLinkModel(type: "", id: "", categoryId: ""))
    }
    ...
    func handleDeepLink(data: DeepLinkModel) {
        ...
        vc.data = data
        vc.originRoot = window?.rootViewController
